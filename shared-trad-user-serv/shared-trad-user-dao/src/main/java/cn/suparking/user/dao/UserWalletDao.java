 ...
 * user wallet Dao.
 */
public interface UserWalletDao extends JpaRepository<UserWalletDO, String> {
     ...
     */
    Optional<UserWalletDO> findById(String id);
     ...
     * @return {@link Optional}
     */
    Optional<UserWalletDO> findByUserId(String userId);
     ...
     */
    @Modifying
    @Query("update UserWalletDO u set u.amount = :amount, u.dateUpdated = :dateUpdated where u.id = :id")
     ...
     */
    @Modifying
    @Query("update UserWalletDO u set u.amount = :amount, u.dateUpdated = :dateUpdated where u.userId = :userId")
