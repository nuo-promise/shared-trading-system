...
public class RabbitUtils {
     ...
     */
    public void sendRabbitAck(final Message message, final String from, final String topic, final JSONObject retBody) {
        ...
        if (Objects.nonNull(replyTo)) {
            ...
            Message messageRet = new Message(retBody.toJSONString().getBytes(), replyMessageProperties);
